...
{
	#[inline(always)]
	pub(crate) fn new(can_i_use: &CanIUse, agents: &AgentNameAndVersionSet) -> Vec<PropertyNamePropertyDeclarationAutoprefixer>
	{
		let generators = vec!
		[
	...
	#[inline(always)]
	fn generate(&self, can_i_use: &CanIUse, agents: &AgentNameAndVersionSet, autoprefixers: &mut Vec<PropertyNamePropertyDeclarationAutoprefixer>)
	{
